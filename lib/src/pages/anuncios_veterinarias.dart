...
class AnunciosVeterinarias extends StatefulWidget {
  AnunciosVeterinarias({Key? key}) : super(key: key);
  static const String routeName = 'anuncios-veterinaria';

  @override
  _AnunciosVeterinariasState createState() => _AnunciosVeterinariasState();
}

class _AnunciosVeterinariasState extends State<AnunciosVeterinarias> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ANUNCIOS DE VETERINARIAS'),
  ...
  Widget _anunciosAlbergue(context){
    final card = Column(
      children: <Widget>[
        ...
        ListTile(
          leading: Icon(Icons.fmd_good_outlined, color: _color_icono),
          title: Text('Dirección:',style:_estiloTextoNegrita),
